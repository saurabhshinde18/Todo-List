      ...
      <div className="w-[40%] h-[80%] flex justify-center bg-amber-500">
        <div className="h-[70%] mt-16  text-center flex-col ">
          <form
            ...
            className="border h-[90%] p-8"
          >
            <h3 className="text-red-600 text-4xl font-thin ">Add Task</h3>
            <input
              {...register("title", { required: "this field is required" })}
              type="text"
              className="mt-4 tex-center text-2xl border"
              placeholder="Enter Your Task"
            />
            <br />
            {errors.title && (
              <small className="font-thin text-red-900">
                {errors.title.message}
              </small>
            )}
            <br />
            <button className="mt-[5%] border m-5 p-3 hover:scale-110 bg-orange-500">
              Add Task
            </button>
          </form>
        </div>
